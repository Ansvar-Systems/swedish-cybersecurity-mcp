...
[![npm version](https://badge.fury.io/js/%40ansvar%2Fswedish-cybersecurity-mcp.svg)](https://www.npmjs.com/package/@ansvar/swedish-cybersecurity-mcp)
[![License](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![CI](https://github.com/Ansvar-Systems/swedish-cybersecurity-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/Ansvar-Systems/swedish-cybersecurity-mcp/actions/workflows/ci.yml)
...
**Endpoint:** `https://mcp.ansvar.eu/swedish-cybersecurity/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add swedish-cybersecurity-mcp --transport http https://mcp.ansvar.eu/swedish-cybersecurity/mcp` |
...
```json
{
  "mcpServers": {
    "swedish-cybersecurity-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/swedish-cybersecurity/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/swedish-cybersecurity-mcp
```
...
```json
{
  "mcpServers": {
    "swedish-cybersecurity-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/swedish-cybersecurity-mcp"]
    }
  }
}
```
...
| Tool | Description |
|------|-------------|
| `se_cyber_search_guidance` | Full-text search across BSI guidelines and technical reports. Covers Technical Guidelines (TR series), IT-Grundschutz... |
| `se_cyber_get_guidance` | Get a specific BSI guidance document by reference (e.g., |
| `se_cyber_search_advisories` | Search BSI security advisories and alerts. Returns advisories with severity, affected products, and CVE references wh... |
| `se_cyber_get_advisory` | Get a specific BSI security advisory by reference (e.g., |
| `se_cyber_list_frameworks` | List all BSI frameworks and standard series covered in this MCP, including IT-Grundschutz Kompendium, BSI Technical G... |
| `se_cyber_about` | Return metadata about this MCP server: version, data source, coverage, and tool list. |
